...
type deleteRequest = *pbs.DeleteUserRequest
type deleteResponse = *pbs.DeleteUserResponse

// DeleteUser implements the interface pbs.CredentialLibraryServiceServer.
