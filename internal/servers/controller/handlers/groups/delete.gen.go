...
type deleteRequest = *pbs.DeleteGroupRequest
type deleteResponse = *pbs.DeleteGroupResponse

// DeleteGroup implements the interface pbs.CredentialLibraryServiceServer.
func (s Service) DeleteGroup(ctx context.Context, req deleteRequest) (deleteResponse, error) {
