...
function has_default_target_actions() {
  local out=$1
  local actions=('read' 'update' 'delete' 'add-host-sources' 'set-host-sources' 'remove-host-sources' 'add-credential-sources' 'set-credential-sources' 'remove-credential-sources' 'authorize-session')
